...
//                                    3.76043739432868451e-01));
        ...
        pose_c2w = traact::spatial::Translation3D(-2.132084e+00, -1.206382e+00, 2.304512e+00);
        pose_c2w.rotate(traact::spatial::Rotation3D(-8.496948e-01,
                                                    -3.461995e-01,
                                                    1.294438e-01,
                                                    3.760437e-01));
...
//        EXPECT_NEAR(residuals[1], 0, 1e-6);
        EXPECT_NEAR(residuals[0], 0, 5e-5);
        EXPECT_NEAR(residuals[1], 0, 5e-5);
